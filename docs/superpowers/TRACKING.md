...
| B5 — Reload active theme on file change | [`specs/2026-06-09-theme-reload-on-change-design.md`](specs/2026-06-09-theme-reload-on-change-design.md) | [`plans/2026-06-09-theme-reload-on-change.md`](plans/2026-06-09-theme-reload-on-change.md) | 4 tasks + cycle_theme source-refresh fix + README; lib tests 247 → 256 |
